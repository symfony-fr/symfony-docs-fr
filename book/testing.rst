...
unitaires standards PHPUnit. Supposez, par exemple, que vous avez une classe
...
Pour des détails spécifiques sur l'utilisation du profileur au sein d'un test,
...
Si vous voulez que le client suive automatiquement toutes les redirections,
...
le DOM d'un document HTML/XML. Par exemple, le code suivant trouve tous les éléments
...
Vous pouvez aussi réécrire les en-têtes HTTP par requête (c.-à-d. et non pas pour
toutes les requêtes) :
