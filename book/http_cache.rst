...
.. tip::
    ...
    Il faut ne garder à l'esprit que « HTTP » n'est rien d'autre que le
...
* Quand une page est dynamique (c.-à-d. quand son contenu change
...
passerelle de cache (c.-à-d. à l'extérieur de l'application). Comme vous
