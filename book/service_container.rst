...
.. sidebar:: Pourquoi ne pas injecter le service ``request`` ?
    ...
    seule instance est créée par le conteneur qui la renvoie à chaque fois que vous demandez un service
    ou quand il est injecté dans un autre service. Il y a une exception dans une application
